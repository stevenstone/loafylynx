...
type Position = "NW" | "N" | "NE" | "E" | "SE" | "S" | "SW" | "W" | null;

export const Idyllic: FC = () => {
    const [firstClones, setFirstClones] = useState<"cardinal" | "intercardinal" | null>();
    const [clonePosition, setClonePosition] = useState<Position>();
    const [coneZone, setConeZone] = useState<"north" | "south" | null>();
    const [stackOrDefamFirst, setStackOrDefamFirst] = useState<"stack" | "defam" | null>();
    const [towerPosition, setTowerPosition] = useState<"left" | "right" | null>();
    const [blackHoleSafe, setBlackHoleSafe] = useState<"NS" | "EW" | null>();
    const [safePlatform, setSafePlatform] = useState<"E" | "W" | null>();
